...
public class BDeathState : StateMachineBehaviour {
    ...
    public float timeToDespawn = 5.0f;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (eControl != null)
        {
            ...
            // Reset the animator and return to pool
            if (timer >= timeToDespawn && !revived)
            {
                ...
                eControl.spawnable.RemoveFromSpawner(true);
